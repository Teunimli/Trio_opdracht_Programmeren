...
public class TableClickEvent implements MouseListener {
    ...
    public void mouseClicked(MouseEvent e) {
        if (comboBoxselect.getSelectedItem() == "Account")
        {
            ...
            textField.setText(table.getModel().getValueAt(row,2).toString());
            textField_1.setText(table.getModel().getValueAt(row,3).toString());
            textField_2.setText(table.getModel().getValueAt(row,4).toString());
            textField_3.setText(table.getModel().getValueAt(row,5).toString());
            textField_4.setText(table.getModel().getValueAt(row,6).toString());
